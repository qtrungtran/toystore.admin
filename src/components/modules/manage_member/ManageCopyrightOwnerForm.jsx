  ...
  return (
    <Container maxWidth="sm">
      <MuiPickersUtilsProvider utils={DateFnsUtils}>
        <Form>
          <Box mb={3}>
            <Typography color="textPrimary" align="center" variant="h1">
          ...
          <Box mb={3}>
            ...
            <Box mb={2}>
              ...
              <Field
                ...
                fullWidth
                // onChange={(event) => {
                //   values.companyDetails.registration_docs_proof =
...
const ManageCopyrightOwnerForm = () => {
  return <Formik initialValues={initialValues} component={InnerForm} />;
};

export default ManageCopyrightOwnerForm;
